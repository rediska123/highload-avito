...
<img width="700" height="450" alt="Untitled(1)" src="https://github.com/user-attachments/assets/dbb6471e-01e7-46fb-a6f3-679b1410d280" />
...
## Физическая схема БД
<img width="1380" height="1092" alt="изображение" src="https://github.com/user-attachments/assets/2f402d22-21b1-497a-8b91-8f7811705864" />
...
|------------------------|------------------------------------------|-------------------------|
| items_search           | -                                        | 3 реплики               |
| search_metrics         | -                                        | 1 реплика               |
| items                  | 8 шардов по item_id mod 8                | 4 реплики               |
| images                 | -                                        | 3 реплики               |
| favorites              | 4 шарда по profile_id mod 4              | 1 реплика               |
...
- ClickHouse — встроенный балансировщик
- Redis — встроенный
